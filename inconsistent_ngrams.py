...
if __name__ == '__main__':
    ...
    generate_path = lambda x, y: os.path.join(JULGAMENTO_FOLDER, "static", "uploads", "CM-" + os.path.basename(sys.argv[1]).rsplit(".conllu", 1)[0], 'results_{}.{}'.format(x, y))
    dirname = os.path.join(JULGAMENTO_FOLDER, "static", "uploads", "CM-" + os.path.basename(sys.argv[1]).rsplit(".conllu", 1)[0])
    ...
    html_file = generate_path(type_filter, "html")
    json_file = generate_path(type_filter, "json")
